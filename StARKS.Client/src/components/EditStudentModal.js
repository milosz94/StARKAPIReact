                  ...
                  <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                      ...
                      <input id="adress" name="adress" type="text"
                             ...
                             onChange={this.handleOnAdressChange.bind(this)}
                             required/>
                    </div>
                    <br/>
                    <div className="form-group">
                      ...
                      <input id="city" name="city" type="text"
                             ...
                             onChange={this.handleOnCityChange.bind(this)}
                             required/>
                    </div>
                    <br/>
                    <div className="form-group">
                      ...
                      <input id="state" name="state" type="text"
                             ...
                             onChange={this.handleOnStateChange.bind(this)}
                             required/>
                    </div>
                    <br/>
                    <div className="form-group">
                      ...
                      <input id="dateOfBirth" name="dateOfBirth" type="text"
                             ...
                             onChange={this.handleOndateOfBirthChange.bind(
                                 this)} required/>
                    </div>
                    <br/>
                    <div className="form-group">
                      <button className="btn btn-light pull-right">Edit
                        Student
                      </button>
